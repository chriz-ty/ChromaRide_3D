...
const loader = new GLTFLoader(loadingManager).setPath('public/lambo2021/');
loader.load('scene.gltf', (gltf) => {
    ...
    mesh.traverse((child) => {
        if (child.isMesh) {
            ...
            if (child.material && 
                (child.material.name.toLowerCase().includes('material.012') || 
                 child.name.toLowerCase().includes('material.012') || 
