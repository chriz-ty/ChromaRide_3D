...
const loader = new GLTFLoader(loadingManager).setPath('public/bmw507/');
loader.load('scene.gltf', (gltf) => {
    ...
    mesh.traverse((child) => {
        if (child.isMesh) {
            ...
            if (child.material && 
                (child.material.name.toLowerCase().includes('glossy_black.001') || 
                 child.name.toLowerCase().includes('glossy_black.001') || 
